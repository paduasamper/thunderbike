          ...
          if ($result->num_rows > 0) {
              while($row = $result->fetch_assoc()) {
                  ...
                  echo "<td>
                          ...
                          <a href='../controladores/ELIMINAR_REPARACIONES.PHP?id=" . $row['id'] . "' class='btn btn-danger btn-sm' onclick='return confirm(\"¿Eliminar esta reparación?\");'>Eliminar</a>
                        </td>";
                  echo "</tr>";
              }
          } else {
...
<div class="modal fade" id="addModal" tabindex="-1" aria-labelledby="addModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form action="../controladores/AGREGAR_REPARACIONES.PHP" method="post">
...
<div class="modal fade" id="editModal" tabindex="-1" aria-labelledby="editModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form id="editForm" action="../controladores/EDITAR_REPARACIONES.PHP" method="post">
        <div class="modal-body">
...
function loadEditForm(id) {
  ...
  fetch(`../controladores/OBTENER_REPARARACIONES.PHP?id=${id}`)
