...
<head>
    ...
    gap: 5px; /* Espaciado entre el logo y el título */
}
    ...
    margin: 0;
    padding: 0;
    list-style: none; /* Quitar viñetas si es una lista */
}
...
<div class="header-container">
    ...
    <div class="logo-title">
        <img src="img/thunderbikes.png" alt="Thunderbikes" width="60" height="60">
        <h1>THUNDERBIKE</h1>
    </div>
